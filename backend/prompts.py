...
DEFAULT_EVAL_PROMPT = (
    f"{BACKGROUND_PROMPT} "
    "Determine whether the study is relevant to the report's intent. You may receive "
    "PDF attachments; these are reports associated with the current study. The text "
    "payload includes pdf_attachments with attachment_index, study_id, report_id, and "
    "title. Use these attachments as supporting evidence. This is the first pass: "
...
DEFAULT_LIKELY_GROUP_PROMPT = (
    ...
    "other studies. You may receive PDF attachments; these are reports associated with "
    "the candidate studies listed. The text payload includes pdf_attachments with "
    "attachment_index, study_id, report_id, and title. Use these attachments as "
    "supporting evidence. If none are strong, return an empty list. Respond ONLY as json "
...
DEFAULT_LIKELY_COMPARE_PROMPT = (
    ...
    "Explain why you picked that study and not the other. You may receive PDF attachments; "
    "these are reports associated with the candidate studies listed. The text payload "
    "includes pdf_attachments with attachment_index, study_id, report_id, and title. Use "
    "these attachments as supporting evidence. Respond ONLY as json with keys: decision "
...
DEFAULT_UNSURE_REVIEW_PROMPT = (
    ...
    "not_match. You may receive PDF attachments; these are reports associated with the "
    "current study. The text payload includes pdf_attachments with attachment_index, "
    "study_id, report_id, and title. Use these attachments as supporting evidence. "
...
DEFAULT_SUMMARY_PROMPT = (
    ...
    "may receive PDF attachments; these are reports associated with the studies referenced "
    "in the payload. The text payload includes pdf_attachments with attachment_index, "
    "study_id, report_id, and title. Use these attachments as supporting evidence. "
